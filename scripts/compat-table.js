...
const features = {
  // ES5 features
  "Object/array literal extensions: Getter accessors": {
    target: "ObjectAccessors",
  },
  "Object/array literal extensions: Setter accessors": {
    target: "ObjectAccessors",
  },
  ...
  "instance class fields: private instance class fields basic support": {
    target: "ClassPrivateField",
  },
  "instance class fields: private instance class fields initializers": {
    target: "ClassPrivateField",
  },
  "instance class fields: optional private instance class fields access": {
    target: "ClassPrivateField",
  },
  "instance class fields: optional deep private instance class fields access": {
    target: "ClassPrivateField",
  },
  "static class fields: private static class fields": {
    target: "ClassPrivateStaticField",
  },

  // Private methods
  "private class methods: private instance methods": {
    target: "ClassPrivateMethod",
  },
  "private class methods: private accessor properties": {
    target: "ClassPrivateAccessor",
  },
  "private class methods: private static methods": {
    target: "ClassPrivateStaticMethod",
  },
  "private class methods: private static accessor properties": {
    target: "ClassPrivateStaticAccessor",
  },

  // Private "in"
  "Ergonomic brand checks for private fields": {
    target: "ClassPrivateBrandCheck",
  },
};
...
function mergeVersions(target, res) {
    ...
    if (res[key] === true) {
      ...
      if (match) {
        ...
        if (engines.indexOf(engine) >= 0) {
          ...
          if (
            !lowestVersionMap[engine] ||
            compareVersions(
              { version },
              { version: lowestVersionMap[engine] }
            ) < 0
          ) {
  ...
  for (const engine in lowestVersionMap) {
    ...
    if (
      !highestVersionMap[engine] ||
      compareVersions(
        { version },
        { version: highestVersionMap[engine][0].start }
      ) > 0
    ) {
...
versions.NodeColonPrefixImport = {
  node: [{ start: [12, 20], end: [13] }, { start: [14, 13, 1] }],
};
versions.NodeColonPrefixRequire = {
  node: [{ start: [14, 18], end: [15] }, { start: [16] }],
};
...
fs.writeFileSync(
  __dirname + "/../internal/compat/js_table.go",
...
fs.writeFileSync(
  __dirname + "/../pkg/api/api_js_table.go",
  `// This file was automatically generated by "${path.basename(__filename)}"
...
${engines
  .filter((x) => x !== "es")
  .map((x, i) => `\tEngine${upper(x)}${i ? "" : " EngineName = iota"}`)
  .join("\n")}
)
...
${engines
  .filter((x) => x !== "es")
  .map((x) => `\tcase Engine${upper(x)}:\n\t\treturn compat.${upper(x)}`)
  .join("\n")}
\tdefault:
...
fs.writeFileSync(
  __dirname + "/../pkg/cli/cli_js_table.go",
  `// This file was automatically generated by "${path.basename(__filename)}"
