(async () => {
  ...
  // Tests for "--define"
  tests.push(
    test(["--define:foo=null", "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== null) throw 'fail'`,
    }),
    test(["--define:foo=true", "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== true) throw 'fail'`,
    }),
    test(["--define:foo=false", "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== false) throw 'fail'`,
    }),
    test(['--define:foo="abc"', "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== "abc") throw 'fail'`,
    }),
    test(["--define:foo=123.456", "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== 123.456) throw 'fail'`,
    }),
    test(["--define:foo=-123.456", "in.js", "--outfile=node.js"], {
      "in.js": `if (foo !== -123.456) throw 'fail'`,
    }),
    test(["--define:foo=global", "in.js", "--outfile=node.js"], {
      "in.js": `foo.bar = 123; if (bar !== 123) throw 'fail'`,
    }),
    test(["--define:foo=bar", "in.js", "--outfile=node.js"], {
      "in.js": `let bar = {x: 123}; if (foo.x !== 123) throw 'fail'`,
    }),
    test(["--define:a.x=1", "in.js", "--outfile=node.js"], {
      "in.js": `if (a.x !== 1) throw 'fail'`,
    }),
    test(["--define:a.x=1", "--define:a.y=2", "in.js", "--outfile=node.js"], {
      "in.js": `if (a.x + a.y !== 3) throw 'fail'`,
    }),
    test(["--define:a.x=1", "--define:b.y=2", "in.js", "--outfile=node.js"], {
      "in.js": `if (a.x + b.y !== 3) throw 'fail'`,
    }),
    test(["--define:a.x=1", "--define:b.x=2", "in.js", "--outfile=node.js"], {
      "in.js": `if (a.x + b.x !== 3) throw 'fail'`,
    }),
...
`,
    ...
    tests.push(
      ...
      test(["--bundle", "in.js", "--outfile=node.js"], {
        ...
        "node_modules/foo/index.js": {
          symlink: `../../registry/node_modules/foo/index.js`,
        },
      }),
      test(["--bundle", "in.js", "--outfile=node.js"], {
        "in.js": `import {foo} from 'foo'; if (foo !== 123) throw 'fail'`,
        ...
        "registry/node_modules/bar/index.js": `export const bar = 123`,
        "node_modules/foo": {
          symlink: `TEST_DIR_ABS_PATH/registry/node_modules/foo`,
        },
      }),
      test(["--bundle", "in.js", "--outfile=node.js"], {
        "in.js": `import {foo} from 'foo'; if (foo !== 123) throw 'fail'`,
        ...
        "registry/node_modules/bar/index.js": `export const bar = 123`,
        "node_modules/foo/index.js": {
          symlink: `TEST_DIR_ABS_PATH/registry/node_modules/foo/index.js`,
        },
      }),

      // With preserve symlinks
      test(
        ["--bundle", "src/in.js", "--outfile=node.js", "--preserve-symlinks"],
        {
          ...
          "src/node_modules/foo": {
            symlink: `../../registry/node_modules/foo`,
          },
        }
      ),
      test(
      ...
      test(
        ...
        {
          "config/yarn/link/@monorepo-source/a": {
            symlink: `../../../../monorepo-source/packages/a`,
          },
          "config/yarn/link/@monorepo-source/b": {
            symlink: `../../../../monorepo-source/packages/b`,
          },
          "impl/node_modules/@monorepo-source/b": {
            symlink: `../../../config/yarn/link/@monorepo-source/b`,
          },
          "impl/index.mjs": `
        ...
        `,
          "monorepo-source/packages/b/node_modules/@monorepo-source/a": {
            symlink: `../../../../../config/yarn/link/@monorepo-source/a`,
          },
  ...
  tests.push(
    ...
    test(
      ["--bundle", "in.js", "--outfile=node.js"],
      simpleCyclicImportTestCase542
    ),
    test(
      ["--bundle", "in.js", "--outfile=node.js", "--format=iife"],
      simpleCyclicImportTestCase542
    ),
    test(
      [
  ...
  tests.push(
    ...
    test(
      ["--bundle", "in.js", "--outfile=node.js", "--format=cjs", "--minify"],
      {
        "in.js": `export const foo = 123; const out = require('./in'); if (!out.__esModule || out.foo !== 123) throw 'fail'`,
      }
    ),
    ...
    test(
      ["--bundle", "in.js", "--outfile=node.js", "--format=esm", "--minify"],
      {
        "in.js": `export const foo = 123; const out = require('./in'); if (!out.__esModule || out.foo !== 123) throw 'fail'`,
      }
    ),
    ...
    test(
      ["node.ts", "re-export.ts", "a.ts", "b.ts", "--format=cjs", "--outdir=."],
      {
        "node.ts": `
        import {a, b} from './re-export'
        if (a !== 'a' || b !== 'b') throw 'fail'
  ...
  for (const minify of [[], ["--minify"]]) {
    ...
    tests.push(
      ...
      test(
        ["--bundle", "in.js", "--outfile=out.js", "--format=esm"].concat(
          minify
        ),
        {
      ...
      // Self export
      test(
        ["--bundle", "in.js", "--outfile=node.js", "--format=esm"].concat(
          minify
        ),
        {
  ...
  tests.push(
    test(
      ["--bundle", "--format=esm", "in.js", "--outfile=node.js"],
      {
        "in.js": `
        import a from './a'
...
`,
  ...
  tests.push(
    ...
    test(
      ["in.js", "--outfile=node.js", "--format=esm"],
      {
        "in.js": `
        let fn = async () => {
    ...
    test(
      ["in.js", "--outfile=node.js", "--format=cjs"],
      {
        "in.js": `
        let fn = async () => {
          let fs = await import('fs')
    ...
    test(
      ["in.js", "--outfile=out.cjs", "--format=cjs", "--platform=node"],
      {
        "in.js": `
        export let foo = 123
        let bar = 234
    ...
    test(
      ["in.js", "--outfile=out.js", "--format=iife", "--global-name=test"],
      {
        "in.js": `
        let fn = async () => {
          let fs = await import('fs')
    ...
    test(
      ["in.json", "--outfile=out.js", "--format=iife", "--global-name=test"],
      {
        "in.json": `{"foo": 123}`,
        "node.js": `
        const code = require('fs').readFileSync(__dirname + '/out.js', 'utf8')
    ...
    // CJS => ESM
    test(
      ["in.js", "--outfile=out.js", "--format=esm"],
      {
        "in.js": `
        const {exists} = require('fs')
        if (!exists) throw 'fail'
...
`,
  ...
  tests.push(
    ...
    test(
      ["entry.js", "--outfile=node.js", "--bundle", "--minify-identifiers"],
      {
        "entry.js": `
        try {
          require('./src/a')
  ...
  tests.push(
    ...
    test(
      ["in.js", "--outfile=node.js", '--define:foo.bar={"x":0}', "--bundle"],
      {
        "in.js": `if (foo.bar.x !== 0) throw 'fail'; return`,
      }
    ),
    test(
      ["in.js", "--outfile=node.js", '--define:module={"x":0}', "--bundle"],
      {
        "in.js": `if (module.x !== void 0) throw 'fail'; return`,
      }
    ),
    test(
      ["in.js", "--outfile=node.js", '--define:module.foo={"x":0}', "--bundle"],
      {
        "in.js": `if (module.foo !== void 0) throw 'fail'; return`,
      }
    ),
    test(
      ["in.js", "--outfile=node.js", '--define:exports={"x":0}', "--bundle"],
      {
    ...
    test(
      ["in.js", "--outfile=node.js", '--define:module.foo=["x"]', "--bundle"],
      {
        "in.js": `if (module.foo !== void 0) throw 'fail'; return`,
      }
    ),
    ...
    test(
      ["in.js", "--outfile=node.js", '--define:exports.foo=["x"]', "--bundle"],
      {
        "in.js": `if (exports.foo !== void 0) throw 'fail'; return`,
      }
    ),
  ...
  for (const minify of [[], ["--minify-syntax"]]) {
    ...
    for (const access of [[".a"], ['["a"]']]) {
      tests.push(
        ...
        test(
          ["in.js", "--outfile=node.js", "--log-level=error"].concat(minify),
          {
  ...
  tests.push(
    // Arrow functions
    test(
      ["in.js", "--outfile=node.js", "--minify", "--keep-names", "--bundle"],
      {
    ...
    test(
      ["in.js", "--outfile=out.js", "--minify", "--keep-names", "--format=esm"],
      {
  ...
  tests.push(
    test(
      ["in.js", "--outfile=out.js", "--format=esm", "--minify", "--bundle"],
      {
        "in.js": `
        var worked = false
  ...
  for (let flags of [[], ["--target=es6"]]) {
    ...
    tests.push(
      ...
      test(
        ["in.js", "--outfile=node.js"].concat(flags),
        {
          "in.js": `
...
`,
      ...
      test(
        ["in.js", "--outfile=node.js", "--bundle", "--keep-names"].concat(
          flags
        ),
        {
          "in.js": `
  ...
  for (let flags of [[], ["--target=es2017"], ["--target=es6"]]) {
    tests.push(
      ...
      test(
        ["in.js", "--outfile=node.js", "--keep-names", "--bundle"].concat(
          flags
        ),
        {
  ...
  tests.push(
    ...
    test(
      ["a.js", "--outdir=out", "--splitting", "--format=esm", "--bundle"],
      {
        "a.js": `
    ...
    test(
      ["entry.js", "--outdir=out", "--splitting", "--format=esm", "--bundle"],
      {
    ...
    test(
      ["parent.js", "--outdir=out", "--splitting", "--format=esm", "--bundle"],
      {
        "parent.js": `
  ...
  // Test file handle errors other than ENOENT
  {
    ...
    tests.push(
      test(
        ["src/entry.js", "--bundle", "--outfile=node.js", "--sourcemap"],
        {
          "src/entry.js": `
...
`,
      ...
      test(
        ["src/entry.js", "--bundle", "--outfile=node.js"],
        {
          "src/entry.js": ``,
...
`,
  ...
  tests.push(
    test(
      ["in.js", `'--define:process.env.NODE_ENV="production"'`],
      {
        "in.js": ``,
      },
      {
        expectedStderr:
          `${errorIcon} [ERROR] Unexpected single quote character before flag: '--define:process.env.NODE_ENV="production"'
...
`,
  ...
  tests.push(
    test(
      ["in.js", "--outfile=node.js", "--banner:js=const bannerDefined = true;"],
      {
  ...
  for (const flags of [[], ["--bundle"]]) {
    ...
    if (flags.length === 0 && nodeMajorVersion >= 17) {
      console.log(
        `Skipping tests with path mappings ending in "/" since you are running node 17+`
      );
    } else {
      tests.push(
        test(["in.js", "--outfile=node.js", "--format=esm"].concat(flags), {
  ...
  tests.push(
    ...
    testStdout("exports.foo = 123", ["--sourcemap"], async (build) => {
      ...
      const json = JSON.parse(
        Buffer.from(stdout.slice(start.length), "base64").toString()
      );
  ...
  function test(args, files, options) {
    return async () => {
      ...
      for (const format of formats) {
        ...
        const logLevelArgs = args.some((arg) => arg.startsWith("--log-level="))
          ? []
          : ["--log-level=warning"];
        const modifiedArgs = (
          !hasBundle || args.includes(formatArg) ? args : args.concat(formatArg)
        ).concat(logLevelArgs);
        ...
        try {
          ...
          for (const file in files) {
            ...
            if (contents.symlink)
              await fs.symlink(
                contents.symlink.replace("TEST_DIR_ABS_PATH", thisTestDir),
                filePath
              );
          ...
          if (options && options.cwd) {
            ...
            const command = ["cd", quote(cwd), "&&", quote(esbuildPath)]
              .concat(modifiedArgs.map(quote))
              .join(" ");
          ...
          const pjExists = await fs.stat(pjPath).then(
            () => true,
            () => false
          );
          let testExports;
      ...
      try {
        ...
        await callback(async () => {
          const { stdout } = await execFileAsync(
            esbuildPath,
            [inputFile, "--log-level=warning"].concat(args),
